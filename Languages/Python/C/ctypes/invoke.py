...
# DLL standard di CTypes untuk Windows dapat diimport melalui
...
print("Types dan offset Vector:\nx={}\ny={}\nz={}".format(Vector.x, Vector.y, Vector.z))

### Memanggil fungsi dengan tipe struktur
