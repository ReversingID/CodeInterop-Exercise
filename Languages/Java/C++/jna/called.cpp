...
Compile:
	[gcc]
		(x64)
		$ g++ -m64 -shared -o called.dll -Wl,--out-implib,libcalled.a called.cpp

		(x86)
		$ g++ -m32 -shared -o called.dll -Wl,--out-implib,libcalled.a called.cpp
...
diubah menjadi:
	$ cl /LD called.cpp kernel32.lib advapi32.lib user32.lib
*/
#ifdef _MSC_VER
